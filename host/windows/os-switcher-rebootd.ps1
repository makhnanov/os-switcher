...
# а плата по щелчку выключателя шлёт COUNTDOWN и CANCEL по возврату.
# Уведомления и сама перезагрузка вживую не гонялись — их за проверенные
# не выдавай. Руками, чтобы видеть вывод живьём:
